...
//li.deleteEvenPositions();
//li.arrangeOddEven();
//li.printListUsingFor();
//li.printListUsingFor();
//li.rotateLeft(2);
//li.removeDuplicates();
//li.removeLastOccurance(1);
//li.moveKeyToBack(1);
//li.printListUsingFor();
//li.moveKeyToBack(2);
//li.printListUsingFor();
//cout<<endl<<li.maxRec();
//cout<<endl<<(54%5);
//cout<<li.isSameList(&li2);


//cout<<(li.getNodeFromBack(4)? li.getNodeFromBack(4)->value : -1);
/*
cout<<li.search(51);

cout<<endl;
    cout<<(li.get_NodeByPos(3)?
       li.get_NodeByPos(3)->value3
